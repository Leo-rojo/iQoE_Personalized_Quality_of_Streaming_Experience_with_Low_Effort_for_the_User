...
from park.envs.abr_sim.trace_loader import \
    load_traces, load_chunk_sizes, get_chunk_time #sample_trace,
...
class ABRSimEnv(core.Env):
    ...
    * REFERENCE *
    ...
    """
    def __init__(self):
        #save index of traces
        self.trace_idx=0
        #save rebuffer time for episode
        self.reb_time_array=[]
        ...
        self.bitrate_map = [0.235, 0.375, 0.560, 0.750, 1.050, 1.750, 2.350, 3, 4.3, 5.8, 8.1, 11.6, 16.8]  # Mbps
    ...
    def observe(self):
        ...
        obs_arr.extend(self.chunk_sizes[i][valid_chunk_idx] for i in range(13))
    ...
    def reset(self):
        self.trace, self.curr_t_idx = self.all_traces[self.trace_idx], 0 #sample_trace(self.all_traces, self.np_random)
    ...
    def setup_space(self):
        ...
        self.obs_low = np.array([0] * 18)
        self.obs_high = np.array([
            10e6, 100, 100, 500, 12, 10e6, 10e6, 10e6, 10e6, 10e6, 10e6,10e6, 10e6, 10e6, 10e6, 10e6, 10e6,10e6])
    ...
    def step(self, action):
        ...
        self.reb_time_array.append(rebuffer_time)
        ...
        reward = self.bitrate_map[action] - rebuffer_time - bitrate_change
