...
plt.plot(b, [1,2,3,4,5,6,7,8], stile[1],color =colori[2], linewidth=7,label='iGS+SVR')
plt.plot(b, [1,2,3,4,5,6,7,8], stile[2],color =colori[4], linewidth=7,label='iGS+RF')
plt.plot(c, [1,2,3,4,5,6,7,8], stile[3],color =colori[0],linewidth=7,label='iGS+GP')
